...
const conversations = {
    "Dr. Warren": [
        { from: "Dr. Warren", time: "Mar 3, 8:10 AM", content: "Good question, Arjun. Yes, ApoB was included. Your result was 92 mg/dL — borderline elevated. This is why Carla and I have prioritized fiber + exercise consistency. We’ll re-test in 6 weeks with your next quarterly panel to see if interventions are working.", isUser: false },
        { from: "Dr. Warren", time: "Mar 13, 11:30 AM", content: "Thanks for flagging. Swelling can have many causes — from high salt meals (common in Japan) to prolonged sitting. Check your BP today. If it’s significantly above baseline, we’ll adjust. Otherwise, hydrate and keep legs elevated when possible.", isUser: false },
        { from: "Dr. Warren", time: "Mar 13, 11:45 AM", content: "Mild rise, likely diet-related. No immediate concern, but we’ll re-check after you return. Please keep logs daily.", isUser: false },
        ...
        { from: "Dr. Warren", time: "Mar 25, 3:25 PM", content: "Yes, but minor. Variability happens. What matters is sustained trend across months. Let’s reinforce consistency.", isUser: false },
        { from: "Dr. Warren", time: "Apr 12, 8:45 AM", content: "Good question. Beetroot is rich in nitrates, which can improve endothelial function and lower BP modestly. It’s generally safe and can be a useful adjunct. Carla can recommend a brand that doesn’t have excess sugar.", isUser: false },
        { from: "Dr. Warren", time: "Apr 19, 10:15 AM", content: "To add — your BP trend is encouraging (avg 125/80 last two weeks). If sustained, we’ll consider discussing a taper of your antihypertensive medication by Q3.", isUser: false },
    ],
    "Rachel": [
        ...
        { from: "Rachel", time: "Apr 1, 8:25 AM", content: "Perfect. Bring any questions you have from the hotel workouts — I’ll tailor the session to make sure you’re confident with substitutions.", isUser: false },
        { from: "Rachel", time: "Apr 2, 8:00 AM", content: "Agreed. We’ll make it a “movement quality” session, not a load progression. The idea is to keep your joints and posture aligned without stressing recovery further.", isUser: false },
        { from: "Rachel", time: "Apr 9, 8:25 AM", content: "I’ll also design a short “jet-lag minimizer” routine you can do in the hotel room on arrival — 15 mins mobility + light cardio bursts.", isUser: false },
        { from: "Rachel", time: "Apr 15, 9:40 AM", content: "Once you land, try the 10-min mobility flow I uploaded: hip openers + spinal rotations + 2 mins plank. It’ll shake off stiffness from the flight.", isUser: false },
        { from: "Rachel", time: "Apr 19, 10:30 AM", content: "Structurally, I’d like one in-person session in May to ensure barbell technique is safe. Ruby can coordinate.", isUser: false },
        { from: "Rachel", time: "Apr 23, 9:55 AM", content: "Okay — likely form fatigue. Send me a short video clip next time. I’ll analyze your mechanics. We want to fix this before adding heavier loads.", isUser: false },
    ],
    "Carla": [
        ...
        { from: "Carla", time: "Mar 4, 11:20 AM", content: "Sending you a list now. One easy option: Sliced fish soup (no fried bits, go light on the MSG broth). It’s heart-friendly and easy when you’re out.", isUser: false },
        ...
        { from: "Carla", time: "Mar 19, 8:25 AM", content: "Exactly. That likely explains the ankle swelling you noticed. Hydration + potassium-rich foods (bananas, spinach, avocado) will help rebalance.", isUser: false },
        ...
        { from: "Carla", time: "Mar 26, 9:30 AM", content: "Absolutely — roasted chickpeas, high-fiber protein bars, apple + almond butter packs. I’ll send you a list with brands available in Singapore supermarkets.", isUser: false },
        { from: "Carla", time: "Apr 3, 10:20 AM", content: "Arjun, following up from your latest labs — ApoB was slightly elevated. To address this, I want to introduce a 2-week trial of psyllium husk supplement (5g daily, mixed in water). Evidence shows it lowers ApoB and LDL by binding cholesterol in the gut.", isUser: false },
        { from: "Carla", time: "Apr 3, 10:28 AM", content: "Neutral taste, just gritty texture. Best to mix in a smoothie or shake. Alternatively, I can recommend capsules, though powder is usually more effective.", isUser: false },
        { from: "Carla", time: "Apr 4, 9:15 AM", content: "That’s great feedback. Quinoa is a good soluble fiber source and provides magnesium, which also helps with BP regulation.", isUser: false },
        { from: "Carla", time: "Apr 5, 11:25 AM", content: "Yes, that’s the fiber expanding. It increases satiety, which can also help reduce snacking. Make sure you’re drinking at least 2L of water daily when taking it to avoid digestive discomfort.", isUser: false },
        { from: "Carla", time: "Apr 10, 9:30 AM", content: "Quick nutrition tip: Jakarta meals often come fried or heavy in oils. I recommend you look for grilled satay (skip the peanut sauce if it’s too sweet) and gado-gado salad with dressing on the side. I’ll add a printable guide for common dishes.", isUser: false },
        { from: "Carla", time: "Apr 12, 8:50 AM", content: "Yes, I’ll shortlist a couple of cold-pressed options available locally. You could try 100ml pre-exercise to also support endurance.", isUser: false },
        { from: "Carla", time: "Apr 17, 12:15 PM", content: "That’s fine, one meal won’t undo progress. For dinner → look for grilled fish or gado-gado salad with dressing on the side. Limit fried foods to once a day max while here. I’ll message you 3 restaurant options near your hotel that have good lighter menus.", isUser: false },
        { from: "Carla", time: "Apr 19, 10:25 AM", content: "Nutrition next step — I’ll work with your chef to build a Mediterranean rotation (fish, olive oil, legumes, nuts). Evidence-based for ApoB and BP.", isUser: false },
        { from: "Carla", time: "Apr 22, 8:10 AM", content: "Common at the start. Your gut is adjusting to increased fiber load. Try splitting into 2 doses (morning + evening). And keep water >2.5L/day. That usually resolves it.", isUser: false },
        { from: "Carla", time: "Apr 26, 10:15 AM", content: "Got it. I’ll add rotation: Greek yogurt parfaits, avocado + wholegrain toast, and egg-white omelets with veggies.", isUser: false },
    ],
    "Advik": [
        ...
        { from: "Advik", time: "Mar 22, 8:57 AM", content: "If unavoidable, at least stop eating 2h before bed and stick to water after dinner.", isUser: false },
        ...
        { from: "Advik", time: "Mar 27, 7:05 AM", content: "Okay — take today light. Avoid strenuous training, hydrate aggressively, and do a short walk outside. Your body is signaling it needs recovery.", isUser: false },
        ...
        { from: "Advik", time: "Apr 2, 7:55 AM", content: "Looking at your data — your HRV dropped 10 ms overnight, and resting HR is elevated. That points toward systemic stress, maybe from travel. I’d recommend keeping the intensity lower. Rachel can adapt the session to focus more on mobility + form drills rather than heavy lifts.", isUser: false },
        { from: "Advik", time: "Apr 7, 7:20 AM", content: "Morning, Arjun. Based on your Whoop trend, we can progress Zone 2 training to 35 mins today. Keep pre-hydration protocol. If dizziness occurs, stop immediately.", isUser: false },
        { from: "Advik", time: "Apr 8, 7:00 AM", content: "Excellent 👏 This confirms your system is tolerating progression well. We’ll hold at 35 mins for 3 more sessions this week, then reassess.", isUser: false },
        { from: "Advik", time: "Apr 16, 7:40 AM", content: "Looking at your data feed — elevated resting HR + suppressed HRV. Today keep it light: 20 min Zone 2 treadmill only. Skip strength. Goal = stabilize nervous system.", isUser: false },
        { from: "Advik", time: "Apr 21, 7:15 AM", content: "Morning, Arjun. Ready to progress Zone 2 to 38 mins today. Please hydrate before and after — weather is very humid this week in Singapore.", isUser: false },
        { from: "Advik", time: "Apr 25, 8:25 AM", content: "Not placebo. Beetroot-derived nitrates improve blood vessel dilation → better oxygen delivery. Your HRV post-session was 12% higher than baseline. Promising signal.", isUser: false },
        { from: "Advik", time: "Apr 29, 7:15 AM", content: "Yes, your Whoop journal showed late-night work emails + screen time. Cortisol spikes can suppress HRV. Let’s make tonight a strict digital cut-off at 9 PM. Add 10 mins of Dr. Evans’ breathing exercise before bed.", isUser: false },
    ],
    "Ruby": [
        ...
        { from: "Ruby", time: "Mar 2, 8:22 AM", content: "Done ✅ Invite sent.", isUser: false },
        ...
        { from: "Ruby", time: "Mar 5, 7:00 AM", content: "Confirmed. Friday next week at 9 AM. Fasting required.", isUser: false },
        ...
        { from: "Ruby", time: "Mar 21, 11:15 AM", content: "Samples have been sent to the lab. We should have results by mid-next week. Dr. Warren will then consolidate and share recommendations.", isUser: false },
        ...
        { from: "Ruby", time: "Apr 1, 8:15 AM", content: "Good morning Arjun 🌞 Hope your trip to KL is going smoothly. Quick reminder: tomorrow you have a scheduled coaching session with Rachel at 7 PM SGT. She’ll focus on reviewing your form for dumbbell rows and squats.", isUser: false },
        { from: "Ruby", time: "Apr 3, 10:35 AM", content: "I’ll order and have it delivered by Saturday morning.", isUser: false },
        { from: "Ruby", time: "Apr 4, 9:00 AM", content: "Checking in — any issues with logistics from this week? Travel went smoothly, chef coordinated with Carla’s food plan?", isUser: false },
        { from: "Ruby", time: "Apr 6, 5:00 PM", content: "Weekly Elyx Report 📊\n* Exercise: 4 sessions completed (2 gym, 2 hotel modifications).\n* Sleep: Average recovery 55%, improving since travel.\n* Nutrition: Psyllium trial started, 1 sodium-heavy day in KL.\n* BP: Avg 127/81 this week, more stable.\n* Stress: One flagged low recovery day, managed adaptively.\nFocus for next week → consistency at home, monitor psyllium tolerance, progress Zone 2 duration.", isUser: false },
        { from: "Ruby", time: "Apr 9, 8:20 AM", content: "Of course. I’ll create a Jakarta Travel Protocol with: hotel gym adaptations, nearby healthy dining options, hydration strategies for the hot/humid climate. You’ll have it by Sunday.", isUser: false },
        { from: "Ruby", time: "Apr 11, 7:50 AM", content: "Good morning. Just confirming — your Q2 review call with Dr. Warren and Neel is scheduled for April 19 at 10 AM SGT, after you return from Jakarta. Agenda: review labs, update interventions, and refine targets for the next quarter.", isUser: false },
        { from: "Ruby", time: "Apr 13, 4:00 PM", content: "Weekly Elyx Report 📊\n* Exercise: 5/6 sessions completed, first full 35-min Zone 2 week.\n* Sleep: Average recovery 61% (best in 2 months).\n* Nutrition: Psyllium integrated, no GI issues. Exploring beetroot trial.\n* BP: Week avg 125/80, very stable.\n* Travel Prep: Jakarta protocol drafted, review tomorrow.", isUser: false },
        { from: "Ruby", time: "Apr 14, 7:00 AM", content: "Good morning. Jakarta protocol has been uploaded to your app. Includes:\n1. Hydration + salt strategy for humid conditions.\n2. Hotel gym adaptation plan.\n3. Meal guide for local restaurants.\n4. 10-min morning mobility flow for travel days.", isUser: false },
        { from: "Ruby", time: "Apr 15, 6:15 AM", content: "Good morning, Arjun. ✈️ Safe travels to Jakarta today. Just a reminder: follow the hydration protocol — 500ml water with electrolytes before boarding, and stand up every 45 mins during flight if possible.", isUser: false },
        { from: "Ruby", time: "Apr 18, 6:45 AM", content: "Reminder — flight back tonight at 9:20 PM. Don’t forget to switch back to Singapore time cues quickly: dinner by 7:30 PM local, then no food until breakfast at SG time. Helps with circadian reset.", isUser: false },
        { from: "Ruby", time: "Apr 19, 10:35 AM", content: "I’ll handle scheduling + travel planning. Updated Q2 plan will be uploaded by EOD.", isUser: false },
        { from: "Ruby", time: "Apr 20, 5:00 PM", content: "Weekly Elyx Report 📊\n* Travel: Jakarta protocol mostly followed, 3/4 workouts completed.\n* Sleep: Recovery disrupted on 2 nights, improving on return.\n* Nutrition: 1–2 fried meals/day in Jakarta, otherwise managed.\n* BP: Stable, average 126/80.\n* Major milestone: Q2 strategy formalized.", isUser: false },
        { from: "Ruby", time: "Apr 24, 7:30 AM", content: "Just a heads-up — May 3rd is available for Rachel’s in-person barbell coaching at your home gym. Shall I book?", isUser: false },
        { from: "Ruby", time: "Apr 24, 7:35 AM", content: "Confirmed. Invite sent.", isUser: false },
        { from: "Ruby", time: "Apr 27, 4:00 PM", content: "Weekly Elyx Report 📊\n* Exercise: 5/6 sessions done, Zone 2 at 38 mins.\n* Sleep: Recovery stable at 63% avg.\n* Nutrition: Psyllium tolerated, beetroot juice trial successful.\n* BP: Average 124/78, best so far 🎉", isUser: false },
        { from: "Ruby", time: "Apr 30, 8:30 AM", content: "End of April summary uploaded to your Plan. Highlights:\n* ApoB-focused nutrition interventions launched.\n* Zone 2 duration steadily increasing.\n* BP trending downward.\n* Stress resilience strategies in place.\nMay → deeper strength training progression, tighter nutrition tracking, and preparation for June diagnostics.", isUser: false },
    ],
    "Neel": [
        { from: "Neel", time: "Apr 13, 4:15 PM", content: "That’s the point, Arjun. This consistency builds resilience. The Q2 review will help us lock in bigger goals — reducing ApoB by double digits and cementing exercise as a lifestyle, not just an intervention.", isUser: false },
        { from: "Neel", time: "Apr 19, 10:00 AM", content: "Good morning, Arjun. Thanks for joining the Q2 review. Here are the key themes:\n1. Autonomic + Cardiovascular Health: Zone 2 progression working well, target = reach 40 min stable sessions by June.\n2. Metabolic Markers: ApoB still elevated (94). New strategies: psyllium adherence + beetroot juice pre-exercise. If not improved in June labs, we may consider medication consult.\n3. Structural Health: Back pain stable. Rachel will progress you into Phase 2 strength program — introducing barbell work with form coaching.\n4. Stress Resilience: Whoop shows improvement in recovery trends; Dr. Evans’ stress-breathing exercise will remain a staple.", isUser: false },
        { from: "Neel", time: "Apr 19, 10:40 AM", content: "Excellent momentum, Arjun. Q2 is about consolidation. By end-June, our goal is: ApoB < 85, Zone 2 at 40 mins, and stable BP <125/80 consistently.", isUser: false },
        { from: "Neel", time: "Apr 27, 4:10 PM", content: "Excellent trajectory, Arjun. We’re right on track for Q2 targets. Keep the consistency — June labs will be our checkpoint.", isUser: false },
    ],
};

const allMessagesFromUser = {
    "Dr. Warren": [
        ...
        { from: "Arjun", time: "Mar 3, 8:20 AM", content: "Got it. Thanks for explaining.", isUser: true },
        { from: "Arjun", time: "Mar 13, 11:15 AM", content: "Woke up with slight ankle swelling. Could it be BP-related?", isUser: true },
        ...
        { from: "Arjun", time: "Apr 12, 8:30 AM", content: "Random question: I read that beetroot juice helps lower BP. Worth trying?", isUser: true },
        { from: "Arjun", time: "Apr 19, 10:20 AM", content: "That’s motivating. I’d love to reduce meds long-term.", isUser: true },
    ],
    "Rachel": [
        ...
        { from: "Arjun", time: "Apr 1, 8:20 AM", content: "Thanks Ruby. KL schedule has been hectic. I’ll be back late tonight but should be fine for tomorrow.", isUser: true },
        { from: "Arjun", time: "Apr 2, 7:40 AM", content: "Morning. Woke up with a mild headache and Whoop shows recovery at 42%. Do you think I should still do the strength session tonight?", isUser: true },
        { from: "Arjun", time: "Apr 2, 8:05 AM", content: "Okay, thanks both.", isUser: true },
        { from: "Arjun", time: "Apr 23, 9:50 AM", content: "A little stiffness after deadlifts, but nothing major.", isUser: true },
    ],
    "Carla": [
        ...
        { from: "Arjun", time: "Mar 10, 12:28 PM", content: "Nice, I’ll try.", isUser: true },
        ...
        { from: "Arjun", time: "Apr 3, 10:25 AM", content: "Does it taste awful?", isUser: true },
        { from: "Arjun", time: "Apr 3, 10:30 AM", content: "Let’s try powder for now.", isUser: true },
        { from: "Arjun", time: "Apr 5, 11:15 AM", content: "Tried psyllium this morning in a protein shake. Felt very full after, almost heavy. Is that normal?", isUser: true },
        { from: "Arjun", time: "Apr 5, 11:28 AM", content: "Got it, will up water intake.", isUser: true },
        { from: "Arjun", time: "Apr 17, 12:05 PM", content: "Lunch with clients — ended up with fried noodles and satay. Carla, not the cleanest. Any tips for dinners here?", isUser: true },
        { from: "Arjun", time: "Apr 22, 8:00 AM", content: "Quick qn — why does psyllium sometimes make me bloated?", isUser: true },
        { from: "Arjun", time: "Apr 26, 10:05 AM", content: "Maybe more variety at breakfast — oats every day gets boring.", isUser: true },
    ],
    "Advik": [
        ...
        { from: "Arjun", time: "Apr 7, 7:25 AM", content: "Okay, planning to do it at 6 PM.", isUser: true },
        { from: "Arjun", time: "Apr 8, 6:45 AM", content: "Did the 35 mins last night — HR stable, no dizziness. Felt solid.", isUser: true },
        { from: "Arjun", time: "Apr 16, 7:30 AM", content: "Slept badly in hotel last night — only 4h 50m according to Oura. Recovery red zone again (33%). Do I still do a workout?", isUser: true },
        { from: "Arjun", time: "Apr 16, 7:45 AM", content: "Okay, treadmill it is.", isUser: true },
        { from: "Arjun", time: "Apr 21, 7:20 AM", content: "Will do. Evening session planned.", isUser: true },
        { from: "Arjun", time: "Apr 25, 8:15 AM", content: "Tried beetroot juice pre-run yesterday. Surprisingly felt more energy. Placebo?", isUser: true },
        { from: "Arjun", time: "Apr 29, 7:00 AM", content: "Noticed HRV dip to 39 ms last night. Could stress be the cause?", isUser: true },
        { from: "Arjun", time: "Apr 29, 7:20 AM", content: "Will try.", isUser: true },
    ],
    "Ruby": [
        ...
        { from: "Arjun", time: "Apr 4, 9:10 AM", content: "All good. Javier (chef) has been trying new recipes — had grilled salmon with quinoa yesterday. Quite good actually.", isUser: true },
        { from: "Arjun", time: "Apr 6, 5:15 PM", content: "Very clear summary, thank you.", isUser: true },
        { from: "Arjun", time: "Apr 9, 8:10 AM", content: "I have a work trip to Jakarta April 15–18. Can you build me a travel plan like we did for Tokyo?", isUser: true },
        { from: "Arjun", time: "Apr 11, 7:55 AM", content: "Locked in.", isUser: true },
        { from: "Arjun", time: "Apr 14, 7:10 AM", content: "Perfect. Will review tonight.", isUser: true },
        { from: "Arjun", time: "Apr 15, 6:15 AM", content: "Thanks Ruby, boarding now. Will do.", isUser: true },
        { from: "Arjun", time: "Apr 18, 6:50 AM", content: "Copy that.", isUser: true },
        { from: "Arjun", time: "Apr 19, 10:45 AM", content: "Understood. Clear targets.", isUser: true },
        { from: "Arjun", time: "Apr 20, 5:10 PM", content: "Good wrap-up, thanks.", isUser: true },
        { from: "Arjun", time: "Apr 24, 7:32 AM", content: "Yes, that works.", isUser: true },
        { from: "Arjun", time: "Apr 30, 8:40 AM", content: "Excellent. Feeling much more in control now than two months ago.", isUser: true },
    ],
    "Neel": [
        { from: "Arjun", time: "Apr 13, 4:10 PM", content: "This feels like momentum.", isUser: true },
        { from: "Arjun", time: "Apr 27, 4:10 PM", content: "Excellent trajectory, Arjun. We’re right on track for Q2 targets. Keep the consistency — June labs will be our checkpoint.", isUser: true },
    ]
};
